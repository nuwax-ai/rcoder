...
- pingora `request_filter`（[mod.rs:113](../../crates/rcoder-proxy/src/service/mod.rs)）解析路径，对 `/proxy/apps/{app_id}/{port}/...` 路由调 `tracker.touch(app_id)`。
