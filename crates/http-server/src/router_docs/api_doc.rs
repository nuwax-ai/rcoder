...
#[openapi(
    paths(
        ...
        app_manager::handlers::purge_app,
    ...
    components(
        ...
        rcoder_engine::userapp_error_page::ErrorPageAdminStatus,
        rcoder_engine::userapp_error_page::ErrorPageStoredSummary,
        rcoder_engine::userapp_error_page::ErrorPageWriteResult,
            ...
            app_manager::models::PurgeAppRequest,
