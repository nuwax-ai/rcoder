...
//!
//! 业务：Java 调 `POST /api/userapp/db/{env}/reset-password|create-database` 管理
...
/// `POST /api/userapp/db/{env}/reset-password` 请求体。
...
/// `POST /api/userapp/db/{env}/create-database` 请求体。
#[derive(Debug, Deserialize, Serialize, Clone, utoipa::ToSchema)]
