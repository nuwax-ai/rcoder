//! agent-mgmt 安装/卸载面（install multipart / from-url / from-npm / uninstall）。
...
use super::super::utils::{
    I18nJsonOrQuery, InstallAgentParams, install_agent as fwd_install,
    uninstall_agent as fwd_uninstall,
};
use super::helpers::{
    build_ctx, default_install_type, resolve_container_target, validate_routing_params,
};
