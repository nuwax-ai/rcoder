...
fn event_from_progress(seq: u64, ev: &BuildProgressEvent) -> Event {
    let name = match ev {
        ...
        BuildProgressEvent::ServiceStarting { .. } => "service_starting",
        BuildProgressEvent::ServiceStartOk { .. } => "service_start_ok",
        BuildProgressEvent::ServiceStartFail { .. } => "service_start_fail",
