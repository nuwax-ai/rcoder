//! SQLite component contracts; distinct from Compose recreation acceptance.
use rcoder_e2e::common::report::JsonlReporter;

#[test]
fn sqlite_storage_lifecycle_contract() {
    if !rcoder_e2e::common::require_context_or_skip() {
        return;
    }
    let report = JsonlReporter::begin(
        "sqlite_storage_lifecycle_contract",
        "sqlite-component",
